...
/***/ function(module, exports, __webpack_require__) {
	...
	function wrapAppResultWithBoilerplate(appFn) {
	  return function wrappedAppFn(ext) {
	    ...
	    return {
	      DOM: wrappedVTree$,
	      History: requests.History.take(2)
	    };
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var view = function view(state$, navbar) {
	  return state$.map(function (_ref2) {
	    var routeValue = _ref2.routeValue;
	    return h("div." + styles.app, {}, [navbar, GSAP(exitOptions, [routeValue[0] === null ? null : routeValue[0]]), GSAP(enterOptions, [!routeValue[1] ? routeValue[0] : routeValue[1]])]);
	  }).distinctUntilChanged();
	};
